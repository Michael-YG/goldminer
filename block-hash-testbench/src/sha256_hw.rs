...
use crate::acc::{vga_ball_hash_t, vga_ball_input_t, write_input, read_done, read_hash, reset};
...
pub fn get_hash(bytes: &[u8]) -> Vec<u8> {
    ...
    for value in [hash.h0, hash.h1, hash.h2, hash.h3, hash.h4, hash.h5, hash.h6, hash.h7] {
